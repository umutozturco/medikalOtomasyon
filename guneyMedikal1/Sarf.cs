...
namespace guneyMedikal1
{
    public partial class Sarf : Form
    {
        ...
        private void btnUrunEkle_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into sarfGrubu (urunKodu,urunAdi,stokAdedi,gelisFiyati,satisFiyati)values(@urunKodu,@urunAdi,@stokAdedi,@gelisFiyati,@satisFiyati)";
        ...
        void Goster()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select*from sarfGrubu", conn);
            da.Fill(dt);
        ...
        private void btnUrunGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "update sarfGrubu set urunAdi=@urunAdi,stokAdedi=@stokAdedi,gelisFiyati=@gelisFiyati,satisFiyati=@satisFiyati where urunKodu=@urunKodu";
        ...
        private void btnUrunSil_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "delete from sarfGrubu where urunKodu = @urunKodu";
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM sarfGrubu WHERE urunAdi" +
                "" +
                " LIKE @searchText";
        ...
        private void Sarf_Load(object sender, EventArgs e)
        {
        ...
        private void btnUrunSat_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select stokAdedi,satisFiyati from sarfGrubu where urunKodu = @urunKodu", connection);
            ...
            if (reader.Read())
            {
                ...
                {
                    stokAdedi--;
                    SqlCommand stokGuncelle = new SqlCommand("update sarfGrubu set stokAdedi = @stokAdedi where urunKodu = @urunKodu", connection);
