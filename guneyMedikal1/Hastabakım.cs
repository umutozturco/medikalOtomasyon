...
{
    public partial class Hastabakım : Form
    {
        public Hastabakım()
        {
            InitializeComponent();
        ...
        private void btnUrunEkle_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into hastaBakim (urunKodu,urunAdi,stokAdedi,gelisFiyati,satisFiyati)values(@urunKodu,@urunAdi,@stokAdedi,@gelisFiyati,@satisFiyati)";
        ...
        void Goster()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select*from hastaBakim", conn);
            da.Fill(dt);
        ...
        private void btnUrunGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "update hastaBakim set urunAdi=@urunAdi,stokAdedi=@stokAdedi,gelisFiyati=@gelisFiyati,satisFiyati=@satisFiyati where urunKodu=@urunKodu";
        ...
        private void btnUrunSil_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "delete from hastaBakim where urunKodu = @urunKodu";
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM hastaBakim WHERE urunAdi" +
                "" +
                " LIKE @searchText";
        ...
        private void Plastik_Load(object sender, EventArgs e)
        {
            Goster();
        }
        ...
        private void btnUrunSat_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select stokAdedi,satisFiyati from hastaBakim where urunKodu = @urunKodu", connection);
            ...
            if (reader.Read())
            {
                ...
                {
                    stokAdedi--;
                    SqlCommand stokGuncelle = new SqlCommand("update hastaBakim set stokAdedi = @stokAdedi where urunKodu = @urunKodu", connection);
        ...
        private void Hastabakım_Resize(object sender, EventArgs e)
        {
