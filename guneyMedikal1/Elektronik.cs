...
{
    public partial class Elektronik : Form
    {
        ...
        {
            InitializeComponent();
            baglanti = new SqlConnection("Data Source=DESKTOP-ECG9JSB;Initial Catalog=guneyMedikal;Integrated Security=True");
        }
        ...
        void Goster()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select*from elektronik", conn);
            da.Fill(dt);
        ...
        {
            string searchText = textBox6.Text.Trim(); // TextBox'ta girilen metni al

            // Veritabanı sorgusu oluştur
            string query = "SELECT * FROM elektronik WHERE urunAdi" +
                "" +
                " LIKE @searchText";
            ...
            {
                command.Parameters.AddWithValue("@searchText", "%" + searchText + "%"); // Metni içeren ürünleri ara
                connection.Open();
        ...
        private void btnUrunEkle_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into elektronik (urunKodu,urunAdi,stokAdedi,gelisFiyati,satisFiyati)values(@urunKodu,@urunAdi,@stokAdedi,@gelisFiyati,@satisFiyati)";
        ...
        private void btnUrunGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "update elektronik set urunAdi=@urunAdi,stokAdedi=@stokAdedi,gelisFiyati=@gelisFiyati,satisFiyati=@satisFiyati where urunKodu=@urunKodu";
        ...
        private void btnUrunSat_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select stokAdedi,satisFiyati from elektronik where urunKodu = @urunKodu",connection);
            ...
            if (reader.Read())
            {
                ...
                {
                    stokAdedi--;
                    SqlCommand stokGuncelle = new SqlCommand("update elektronik set stokAdedi = @stokAdedi where urunKodu = @urunKodu", connection);
        ...
        private void btnUrunSil_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "delete from elektronik where urunKodu = @urunKodu";
