...
namespace guneyMedikal1
{
    public partial class Metal : Form
    {
        ...
        private void lblUrunAra_Click(object sender, EventArgs e)
        {
        ...
        void Goster()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("select*from metal", conn);
            da.Fill(dt);
        ...
        private void btnUrunEkle_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into metal (urunKodu,urunAdi,stokAdedi,gelisFiyati,satisFiyati)values(@urunKodu,@urunAdi,@stokAdedi,@gelisFiyati,@satisFiyati)";
        ...
        private void btnUrunGuncelle_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "update metal set urunAdi=@urunAdi,stokAdedi=@stokAdedi,gelisFiyati=@gelisFiyati,satisFiyati=@satisFiyati where urunKodu=@urunKodu";
        ...
        private void btnUrunSil_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = connection;
            cmd.CommandText = "delete from metal where urunKodu = @urunKodu";
        ...
        private void Metal_Load(object sender, EventArgs e)
        {
        ...
        private void textBox6_TextChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM metal WHERE urunAdi" +
                "" +
                " LIKE @searchText";
        ...
        private void btnUrunSat_Click(object sender, EventArgs e)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("select stokAdedi,satisFiyati from metal where urunKodu = @urunKodu", connection);
            ...
            if (reader.Read())
            {
                ...
                {
                    stokAdedi--;
                    SqlCommand stokGuncelle = new SqlCommand("update metal set stokAdedi = @stokAdedi where urunKodu = @urunKodu", connection);
